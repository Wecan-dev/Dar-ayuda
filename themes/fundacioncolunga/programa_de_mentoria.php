<?php
/*
Template Name: Page Template - Programa de mentoria
*/

$current = 'programa-de-mentoria';
$title = get_the_title();
...
<section class="intro">
  <div class="container">
    ...
    if(!empty($circulos)){
      $show = false;
      foreach ($circulos as $key => $circulo){
        if($circulo['imagen']){
          $show = true;
          break;
        }
        ...
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            <div class="row">
              ...
              }elseif(count($circulos)==5){
                $clase = 'col-xs-6 col-sm-5ths';
              }
              ?>
...
if(!empty($thecontent)) { ?>
<section class="texto-libre pt-0">
	<div class="container">
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
...
if(!empty($mentores)){
  ?>
  <section id="mentores" class="pt-0">
    <div class="container">
      <div class="row">
        <div class="col-md-10 col-md-offset-1">
          <div class="row">
            <?php
              foreach ($mentores as $key => $mentor) {
                ?>
                <!-- inicio mentores -->
                <div class="col-md-6">
                  <div class="mentor">
