  ...
  <?php  if (have_posts()) : ?>
		...
		<div class="container">
			<div class="row no-gutters slider-text align-items-end">
				...
				<span class="mr-2"><a href="<?php echo bloginfo('url') . '/index.php/envases'; ?>">Nuestros Envases <i class="ion-ios-arrow-forward"></i></a></span>
					...
					<h1 class="mb-0 bread"><?php echo single_cat_title('', false); ?></h1>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="container-fluid px-md-4">
				<div class="row justify-content-center pb-5">
					<div class="col-md-7 heading-section text-center ftco-animate">
						<h2>Categoría:  <span><?php echo single_cat_title('', false); ?></span></h2>
					</div>
				</div>
	...
	<?php else : ?>
		...
		<div style="text-align: center;">
			...
			<a style="color: #d42303; font-weight: bold; font-size: 1.5rem;" href="<?php bloginfo('url'); ?>/index.php/envases">Ver envases</a>
		</div>
		</div>
	<?php endif; ?>
<?php get_footer(); ?>