...
function theme_customize_register($wp_customize)
{
	...
	$wp_customize->add_panel(
		'panel1',
		array(
			'title' => 'Ingresa tu hoja de vida',
			'priority' => 1,
		)
	);

	$wp_customize->add_section('banner1', array(
		'title' => 'Imagen y textos',
		'panel' => 'panel1'
	));
...
$wp_customize->add_control(new WP_Customize_Control($wp_customize, 'contacto_phone_control', array(
	...
	$wp_customize->add_control(new WP_Customize_Control($wp_customize, 'contacto_email_control', array(
		'label' => 'Correo',
		'section' => 'contacto',
	...
	$wp_customize->add_setting('Redes_sociales_FB', array(
		'default' => ''
	));

	$wp_customize->add_control(new WP_Customize_Control($wp_customize, 'Redes_sociales_FB_control', array(
		'label' => 'Facebook',
		'section' => 'Redes_sociales',
		'settings' => 'Redes_sociales_FB'
	)));

	$wp_customize->add_setting('Redes_sociales_IG', array(
		'default' => ''
	));

	$wp_customize->add_control(new WP_Customize_Control($wp_customize, 'Redes_sociales_IG_control', array(
		'label' => 'Instagram',
		'section' => 'Redes_sociales',
